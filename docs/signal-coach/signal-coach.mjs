...
import { parsePulseLine } from './pulse-webserial-protocol.mjs?v=20260812-action-first-r2';
import { BrowserSignalCoach, adviceFor, stateColor } from './signal-coach-core.mjs?v=20260812-action-first-r2';
